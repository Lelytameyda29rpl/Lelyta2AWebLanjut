                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="penjualan_id" id="penjualan_id" class="form-control" required>
                            ...
                            @foreach($penjualan as $l)
                                <option value="{{ $l->penjualan_id }}" {{ $penjualan_detail->penjualan_id == $l->penjualan_id ? 'selected' : '' }}>{{ $l->penjualan_kode }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="barang_id" id="barang_id" class="form-control" required>
                            ...
                            @foreach($barang as $l)
                                <option value="{{ $l->barang_id }}" {{ $penjualan_detail->barang_id == $l->barang_id ? 'selected' : '' }}>{{ $l->barang_nama }}</option>
                            @endforeach
                        </select>
