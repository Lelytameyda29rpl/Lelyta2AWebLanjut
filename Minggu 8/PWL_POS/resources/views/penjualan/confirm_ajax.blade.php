            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table-sm table-bordered table-striped">
                        <tr><th class="text-right col-3">Nama User :</th><td class="col-9">{{$penjualan->user->nama }}</td></tr>
                        ...
                        <tr><th class="text-right col-3">Tanggal Penjualan :</th><td class="col-9">{{ \Carbon\Carbon::parse($penjualan->penjualan_tanggal)->translatedFormat('d F Y') }}</td></tr>
                    </table>
                </div>
